...
if (!empty($items)): ?>
<video id="<?php print $player_id; ?>-video" class="video-js vjs-default-skin" width="<?php print($width) ?>" height="<?php print($height) ?>" controls="controls" preload="auto"<?php echo $attrs; ?> data-setup='{
